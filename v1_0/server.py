    ...
    <div style="width: 300px; align-items: center; margin:0px auto;">
        <form action="/login" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="username_input" name="username" placeholder="请输入学号">
            </div>
            <div class="form-group">
                <label for="passwd"><strong>密码：</strong></label>
                <input type="password" class="form-control" id="passwd_input" name="password" placeholder="请输入密码">
            </div>
            <br>
            <div style="text-align: center"><button type="submit" class="btn btn-primary">登录</button></div>
        </form>
    </div>
    <div style="width: 300px; align-items: center; margin: auto;">
    <form action="/" method="get">
    <br><br>
        <div class="form-group">
            <div style="text-align: center"><input class="btn btn-primary" type="submit" value="退出,返回身份选择界面"></div>
        </div>
    </form>
    </div>
...
async def login_form_page2(request):
    ...
    <div style="width: 300px; align-items: center; margin:0px auto;">
        <form action="/login" method="post">
            <div class="form-group">
                <label for="username"><strong>账号：</strong></label>
                <input type="text" class="form-control" id="username_input" name="username" placeholder="请输入教工号">
            </div>
            <div class="form-group">
                <label for="passwd"><strong>密码：</strong></label>
                <input type="password" class="form-control" id="passwd_input" name="password" placeholder="请输入密码">
...
async def login_form_page3(request):
    ...
    <div style="width: 300px; align-items: center; margin:0px auto;">
        <form action="/login" method="post">
            <div class="form-group">
                <label for="username"><strong>账号：</strong></label>
                <input type="text" class="form-control" id="username_input" name="username" placeholder="请输入管理账号">
            </div>
            <div class="form-group">
                <label for="passwd"><strong>密码：</strong></label>
                <input type="password" class="form-control" id="passwd_input" name="password" placeholder="请输入密码">
